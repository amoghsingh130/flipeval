...
median churn falling from $0.138$ in S1 to $0.048$ in S2, and by almost exactly
the same factor in the net delta they report, $0.026$ to $0.009$, so the
understatement ratio barely moves: 5.31 in S1 and 5.33 in S2. Two generations of
