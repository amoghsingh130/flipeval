...
\texttt{results/certification\_tables.csv}; the 2\,pp margin is
Table~\ref{tab:certification} in the main text. Note the quadratic margin
scaling: MMLU's median requirement is 8{,}491 items at 1\,pp, 2{,}123 at 2\,pp,
and 944 at 3\,pp.}
% SOURCE: results/certification_tables.csv, rows mmlu at margin_pp 1.0/2.0/3.0,
% column required_n_median.
