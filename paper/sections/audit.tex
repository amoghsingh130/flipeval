...
\revtwoBanner{$K$, $J$, every MDD, every required-$n$ and every shortfall ratio.
These depend on the atlas only through the discordance imputation of
section~\ref{sec:audit-method}, which draws $p_d$ from the atlas's empirical
distribution --- so a changed cell population can move them. \textbf{If $K$ or
$J$ moves, that is a new verdict computation and is documented as one, not a
silent edit.} Unaffected: the reproducibility finding (0 of 17), which is read
directly from the frozen claim table and touches no atlas quantity.}
\label{sec:audit}
...
R07 & SparseGPT                  & 0.23\,pp & 12{,}410 & 131{,}482 & $10.6\times$ \\
R06 & Wanda                      & 0.30\,pp & 18{,}904 &  77{,}282 & $ 4.1\times$ \\
...
R07 & 0.84\,pp & 0.23\,pp & $3.67\times$ & $7.07\times$ \\
R06 & 0.68\,pp & 0.30\,pp & $2.28\times$ & $4.52\times$ \\
