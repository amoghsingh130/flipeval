...
and by $4.4\times$ pooled over 1{,}155 evaluation cells. The requirement is
driven by answer churn rather than task difficulty: MMLU needs about 2{,}123
...
1{,}155 paired model-by-task cells mined from public per-item evaluation dumps,
spanning 3B to 405B parameters. Across the atlas, per-item churn runs roughly
five to six times the net accuracy delta, and 113 cells (9.8\%) post an
