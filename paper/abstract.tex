...
% margin 17, 281 words.
%
% NOT MEASURED for the 2026-08-05 flagship rewrite above: that session had no
% shell and could not run the tool. The rewrite was budgeted by hand against the
% 2026-08-02 measurement and is estimated at roughly 1,860 characters, i.e. a
% margin near 60, deliberately larger than 17 because a hand estimate is not a
% measurement. RUN THE TOOL BEFORE SUBMITTING. If the real figure leaves room,
% the $12.7\times$ controlled churn ratio is the first thing to restore, in the
% mini-grid sentence.
%
